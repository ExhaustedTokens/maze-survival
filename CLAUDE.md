...
- Ogni compito è una issue **nel formato standard** (template "Storia"/"Bug": storia, contesto, criteri di accettazione verificabili, task, fuori scope, dipendenze, "per chi sviluppa", stima; vedi `docs/sviluppo.md` §9). La board è il Project #1 dell'org. Aggiornare la issue, non raccontarlo in chat.
